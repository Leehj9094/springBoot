...
public class ParameterTestController {
	...
	public void p05(@RequestParam(value="name", defaultValue="동동") String name) {
	...
	public void page01(PersonDto dto, Model model) {
		...
		// 반환자료형이 void 일 때 /WEB-INF/view/param/page01.jsp와 매핑
		
		// parameter
		// isValid 
		// service
		// view 이동 + 데이터 전달(Model객체 - DispatherServlet(FC))
